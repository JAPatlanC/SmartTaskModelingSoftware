    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div style="background:#EAE7E6;/* border: 10px black; */border-radius: 10px;padding: 5%;width: 100%;">
            ...
            <fieldset>
                ...
                <legend>Catalogo de Preguntas</legend>
                <table id="myTable">
                    <thead>
                    <tr>
                        <th>Pregunta</th>
                ...
                <div class="form-group">
                    {!! Form::label('pregunta', 'Pregunta:', ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::email('pregunta', $value = null, ['class' => 'form-control', 'placeholder' => 'Ingrese la pregunta...']) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('vpregunta', 'Valor de la pregunta:', ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    {!! Form::label('multipleselect[]', 'Multimedia Relacionada', ['class' => 'col-lg-2 control-label'] )  !!}
                    <div class="col-lg-10">
                        {!!  Form::select('multipleselect[]', ['honda' => 'Video 1', 'toyota' => 'Imagen 1', 'subaru' => 'Archivo 1'], $selected = null, ['class' => 'form-control', 'multiple' => 'multiple']) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('radios', '¿Pregunta activa?', ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        <div class="radio">
                            {!! Form::label('radio1', 'Si') !!}
